...
export const LOGO_URL_ORIGINAL =
...
export const MENU_API_URL =
  "https://www.swiggy.com/dapi/menu/pl?page-type=REGULAR_MENU&complete-menu=true&lat=20.4716294&lng=85.85694040000001&restaurantId=";
